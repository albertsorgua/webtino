...
$direccion = "SELECT direccion FROM clientes WHERE username = $usuario";
?>
<!DOCTYPE html>
<html lang="en">
...
<header id="titulo">
    ...
    <form action="insertarpedido.php" action="mailto:$direccion" method="POST">
        <input type="hidden" name="usuario" value="<?php echo $usuario ?>" />
        <label for="gente">Introduzca la comida que desea pedir:</label>
        <br>
        <textarea name="comida" rows="10" cols="60"></textarea>
        <BR><br>
        <label for="dia">Introduzca la bebida deseada:</label>
        <br>
        <textarea name="bebida" rows="10" cols="60"></textarea>
        <br>
        <br>
